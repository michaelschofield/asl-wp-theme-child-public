...
<html <?php language_attributes(); ?> ng-app="publicServices"><!--<![endif]-->
    ...
    .form__input+.form__input--inside {
      position: absolute;
    }
	</style>
	...
	<body <?php body_class(); ?> data-ng-controller="ApplicationController as ac">
	...
	<a class="hide-accessible" href="#content">Skip to Content</a>
      ...
      <form ng-attr-action="{{ searchtype === 'libweb' ? ( 'http://sharksearch.nova.edu/search' | trusted ) : ( searchtype === 'lists' || searchtype === 'events' ? ('http://sherman.library.nova.edu/sites/spotlight/' | trusted) : ( 'https://novacat.nova.edu/search/X' | trusted ) )}}" role="form" name="novacat_search" id="novacat_search" method="get" class="form has-cards no-margin clearfix search-hero ng-cloak" role="form">
            ...
            <ul class="clearfix">
                  ...
                  <div class="epsilon form__select form__input--full-width no-margin">
                    <select
                      ...
                      <optgroup label="Catalog">
                        ...
                        <option value="lists">Lists of Books and Movies</option>
                        <option value="events">Programs and Events</option>
                    </select>
                  </div>
                </li>
              </div>
              ...
              <div class="col-sm--twelvecol col-md--eightcol">
                <li class="form__field no-margin">
                  ...
                  <ng-if data-ng-if="searchtype === 'lists' || searchtype === 'events'">
                    <label for="searcharg" class="hide-accessible">Search for {{ searchtype === 'lists' ? 'a Book or Movie List' : 'an Upcoming Event' }}</label>
                    <input class="card form__input form__input--full-width input--large epsilon no-margin" id="searcharg" ng-attr-name="{{ searchtype !== 'lists' && searchtype !== 'events'  ? 'searcharg' : 'search' }}" type="search" required data-ng-model="searcharg" data-ng-change="searchtext=searcharg"  style="height: 55px; line-height: 55px;">
                    ...
                    <input type="hidden" name="post_type" value="{{ searchtype === 'lists' ? 'list' : 'spotlight_events' }}">
                  </ng-if>

                  <ng-if data-ng-if="searchtype !== 'libweb' && searchtype !== 'lists' && searchtype !== 'events'">
                  ...
                  <ng-if data-ng-if="searchtype === 'libweb'">
              ...
              <p class="small-text no-margin" style="float: left; line-height: 1.75;" data-ng-if="searchtype !== 'X'"><svg class="svg svg--info" viewBox="0 0 32 32"><path class="path1" d="M18.286 24.571v-2.857q0-0.25-0.161-0.411t-0.411-0.161h-1.714v-9.143q0-0.25-0.161-0.411t-0.411-0.161h-5.714q-0.25 0-0.411 0.161t-0.161 0.411v2.857q0 0.25 0.161 0.411t0.411 0.161h1.714v5.714h-1.714q-0.25 0-0.411 0.161t-0.161 0.411v2.857q0 0.25 0.161 0.411t0.411 0.161h8q0.25 0 0.411-0.161t0.161-0.411zM16 8.571v-2.857q0-0.25-0.161-0.411t-0.411-0.161h-3.429q-0.25 0-0.411 0.161t-0.161 0.411v2.857q0 0.25 0.161 0.411t0.411 0.161h3.429q0.25 0 0.411-0.161t0.161-0.411zM27.429 16q0 3.732-1.839 6.884t-4.991 4.991-6.884 1.839-6.884-1.839-4.991-4.991-1.839-6.884 1.839-6.884 4.991-4.991 6.884-1.839 6.884 1.839 4.991 4.991 1.839 6.884z"></path></svg>
                <ng-if data-ng-if="searchtype == 'a' || searchtype == 'c' || searchtype == 't' || searchtype == 'd'">This is an <mark>index search</mark>. You won't be able to narrow it down to a format (e.g., just e-books). For that, try a <mark>keyword search</mark>.</ng-if>
                <ng-if data-ng-if="searchtype === 'libweb'">Search all our content other than our <a href="http://public.library.nova.edu/research/">databases</a> or <a href="https://novacat.nova.edu">catalog</a>.</ng-if>
                <ng-if data-ng-if="searchtype === 'lists'">We make <a href="http://public.library.nova.edu/lists">lists</a> of movies, books, and music for holidays, birthdays, and major events. </ng-if>
                <ng-if data-ng-if="searchtype === 'events'">Look for upcoming events, workshops, exhibits, and other programs.</ng-if>
              </p>

              <div class="align-right" ng-if="searchtype !== 'libweb' && searchtype !== 'lists'">
