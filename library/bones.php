...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_style( 'pls-stylesheet', get_template_directory_uri() . '/library/css/public-1.9.9.min.css', array(), '', 'all' );

    // ie-only style sheet
    wp_register_style( 'pls-ie-only', get_template_directory_uri() . '/library/css/public-ie-1.9.9.min.css', array(), '' );
