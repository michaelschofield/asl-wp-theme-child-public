...
table_of_contents = function() {
    ...
    var ToC =
        "<ul id='table-of-contents' class='menu table-of-contents'>";

    $( 'article h3[id]' ).each( function() {
...
tabs = function() {
    ...
    openTab = function( $item ) {
        ...
        if( $nav.eq(index).add($content.eq(index)).hasClass('active') ) {
