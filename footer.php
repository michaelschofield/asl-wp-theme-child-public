	        ...
	        <div id="inner-footer" class="wrap clearfix">
	            ...
	            <div class="col-sm--twelvecol col-lg--sixcol align-right">
		            ...
		            <p class="col-sm--twelvecol col-md--fivecol col-lg--twelvecol no-margin zeta">
		                <a class="link link--undecorated" href="//sherman.library.nova.edu/sites/contact/" onclick="_gaq.push(['_trackEvent', 'Footer', 'Click', 'Contact']);">Contact</a> /
      ...
      <script src="//sherman.library.nova.edu/cdn/scripts/ng-apps/publicServices.js"></script>

		<?php wp_footer(); ?>

		<!-- Hotjar Tracking Code for public.library.nova.edu -->
		<script>
		    (function(h,o,t,j,a,r){
		        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
		        h._hjSettings={hjid:115339,hjsv:5};
